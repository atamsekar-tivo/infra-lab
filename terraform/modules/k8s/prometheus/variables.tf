...
variable "grafana_admin_password" {
  description = "Admin password for Grafana. This variable is required. You must provide a strong password; do not leave unset, as the chart's default is insecure."
  type        = string
  sensitive   = true
}
